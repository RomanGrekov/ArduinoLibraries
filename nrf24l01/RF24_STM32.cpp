...
{
  Serial1.print("STATUS = 0x0"); Serial1.print(status,HEX);
  Serial1.print(" RX_DR="); Serial1.print((status & _BV(RX_DR))?1:0);
  Serial1.print(" TX_DS="); Serial1.print((status & _BV(TX_DS))?1:0);
  Serial1.print(" MAX_RT=");Serial1.print((status & _BV(MAX_RT))?1:0);
  Serial1.print(" RX_P_NO=");Serial1.print((status >> RX_P_NO) & 0b111);
  Serial1.print(" TX_FULL=");Serial1.println((status & _BV(TX_FULL))?1:0);
}
...
void RF24::print_byte_register(const char* name, uint8_t reg, uint8_t qty)
{
  ...
  while (qty--) {
    if(read_register(reg) > 0x0F) {
      Serial1.print("0x");
      Serial1.print(read_register(reg++), HEX);
      Serial1.print(" ");
    }
    else {
      Serial1.print("0x0");
...
void RF24::print_address_register(const char* name, uint8_t reg, uint8_t qty)
{
    ...
    printf("%s\t =",name);
  #else
   Serial1.print(name);Serial1.print("\t= ");
  #endif
  while (qty--)
  {
    ...
    while( --bufptr >= buffer ) {
      Serial1.print("0x");Serial1.print(*bufptr, HEX);Serial1.print(" ");
    }
  }
...
void RF24::printDetails(void)
{
  ...
  Serial1.print("Data Rate = ");Serial1.println(pgm_read_word(&rf24_datarate_e_str_P[getDataRate()]));
  Serial1.print("Model = ");Serial1.println(pgm_read_word(&rf24_model_e_str_P[isPVariant()]));
  Serial1.print("CRC Length = ");Serial1.println(pgm_read_word(&rf24_crclength_e_str_P[getCRCLength()]));
  Serial1.print("PA Power = ");Serial1.println(pgm_read_word(&rf24_pa_dbm_e_str_P[getPALevel()]));
