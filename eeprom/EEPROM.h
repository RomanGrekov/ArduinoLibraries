...
#define MCU_STM32F103C8T6
//#define MCU_STM32F103RB

#ifndef EEPROM_PAGE_SIZE
	#if defined (MCU_STM32F103RB) || defined (MCU_STM32F103C8T6)
	...
	#if defined (MCU_STM32F103C8T6)
		#define EEPROM_START_ADDRESS	((uint32)(0x8000000 + 60 * 1024 - 2 * EEPROM_PAGE_SIZE))
